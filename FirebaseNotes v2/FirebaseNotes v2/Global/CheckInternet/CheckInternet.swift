...
//  FirebaseNotes v2
//
//  Created by Сергей Моключенко on 07.05.2020.
...
public class CheckInternet {
    ...
    class func connection() -> Bool {
        ...
        let needsonnection = (flags.rawValue & UInt32(kSCNetworkFlagsConnectionRequired)) != 0
        
        let ret = (isReachable && !needsonnection)
